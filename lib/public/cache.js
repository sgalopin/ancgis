  ...
  event.waitUntil(
    caches.open("ancgis-statics-ressources").then(function(cache) {
      const urls = [
        ...
        "/images/glyphicons/glyphicons-321-filter.png",
        "/images/glyphicons/glyphicons-153-check.png",
        "/images/glyphicons/glyphicons-154-unchecked.png",
        "/images/glyphicons/glyphicons-42-charts.png",
        "/images/glyphicons/glyphicons-530-list-alt.png",
        "/images/glyphicons/glyphicons-140-adjust-alt.png",
        "/images/layerswitcher.png",
        "/images/warning.png",
        "/images/blank.jpg"
      ];
      ...
      if (cacheResponse) {
        ...
        .catch(async function(error) {
          if (
            ...
            if (
              !event.request.url.startsWith("https://ancgis.dev.net/status")
              && !event.request.url.startsWith("https://ancgis.dev.net:3000") // Browser-sync
            ) {
              console.error("Fetching failed:", error); // eslint-disable-line no-console
            }
            // Return HTTP 408 error (Request Timeout)
