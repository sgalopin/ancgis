...
typeof anc != "undefined" ? anc['business'] = {} : anc = {business:{}};
 ...
 * @api
 */
anc.business.indexedDB = function() {
	...
	const taxonData = JSON.parse($.getJSON({'url': "./ressources/json/taxon.json", 'async': false}).responseText);
...
anc.business.indexedDB.prototype.read = function (id) {
...
anc.business.indexedDB.prototype.readAll = function () {
...
anc.business.indexedDB.prototype.add = function (obj) {
...
anc.business.indexedDB.prototype.remove = function (id) {
	var request = this.db.transaction(["taxon"], "readwrite")
	.objectStore("taxon")
	.delete(id);
